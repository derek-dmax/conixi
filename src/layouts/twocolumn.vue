      ...
      <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
          ...
          <router-link to="/" class="logo logo-light">
            <span class="logo-sm">
              <img src="@/assets/images/logo-sm-c.png" alt="" height="30" />
            </span>
            <span class="logo-lg">
              <img src="@/assets/images/c-logo-light-gr.jpg" alt="" height="24" />
            </span>
          </router-link>
          ...
          <div class="container-fluid">
            <div id="two-column-menu">
              <SimpleBar class="twocolumn-iconview list-unstyled">
                <a href="#" class="logo"><img src="@/assets/images/logo-sm-c.png" alt="Logo" height="36" /></a>
                <li>
                ...
                <li>
                  <a class="nav-icon" href="#sidebarlanding" role="button"
