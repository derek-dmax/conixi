            ...
            <div class="text-center mt-sm-5 mb-4 text-white-50">
              <div>
                <router-link to="/" class="d-inline-block auth-logo">
                  <img src="@/assets/images/c-logo-light-tr.png" alt="" height="35">
                </router-link>
              </div>
            ...
            <div class="card mt-4">
              ...
              <div class="card-body p-4">
                <div class="text-center mt-2">
                  ...
                  <p class="text-muted">Get your free Conixi account now</p>
                </div>
                <div class="p-2 mt-4">
                  <form class="needs-validation" @submit.prevent="tryToRegisterIn">
                    ...
                    <div class="mb-4">
                      <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Conixi <a href="#"
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-center">
              <p class="mb-0 text-muted">&copy; {{new Date().getFullYear()}} Conixi. Crafted with <i
                  class="mdi mdi-heart text-danger"></i> by Conixi</p>
            </div>
          </div>
        </div>
      </div>
