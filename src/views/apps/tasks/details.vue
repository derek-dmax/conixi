                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0">
                                <a href="javascript:void(0)">App pages.zip</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0">
                                <a href="javascript:void(0);">Images.zip</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0">
                                <a href="javascript:void(0);">Bg-pattern.png</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr>
                        <th scope="row">
                          <div class="d-flex align-items-center">
                            ...
                            />
                            <div class="flex-grow-1 ms-2">
                              <router-link to="/pages/profile" class="fw-medium"
                                >Thomas Taylor</router-link
                              >
                            </div>
                          </div>
