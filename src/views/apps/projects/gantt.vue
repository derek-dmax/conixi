...
<script>
import Gantt from "../../../components/gantt-comp.vue";
...
export default {
  ...
  data() {
    return {
      tasks: {
		data:[
			{id:1, text:"Office installation", type:gantt.config.types.project, progress: 0.4, open: true},
			{id:2, text:"Office facing", type:gantt.config.types.project, start_date:"2022-04-02", duration:"8", progress: 0.6, parent:"1", open: true},
			{id:3, text:"Furniture installation", type:gantt.config.types.project, start_date:"2022-04-11", duration:"8", parent:"1", progress: 0.6, open: true},
			{id:4, text:"The employee relocation", type:gantt.config.types.project, start_date:"2022-04-13", duration:"6", parent:"1", progress: 0.5, open: true},
			{id:5, text:"Interior office", start_date:"2022-04-02", duration:"7", parent:"2", progress: 0.6, open: true},
			{id:6, text:"Air conditioners check", start_date:"2022-04-03", duration:"7", parent:"2", progress: 0.6, open: true},
			{id:7, text:"Workplaces preparation", start_date:"2022-04-11", duration:"8", parent:"3", progress: 0.6, open: true},
			{id:8, text:"Preparing workplaces", start_date:"2022-04-14", duration:"5", parent:"4", progress: 0.5, open: true},
			{id:9, text:"Workplaces importation", start_date:"2022-04-14", duration:"4", parent:"4", progress: 0.5, open: true},
			{id:10, text:"Workplaces exportation", start_date:"2022-04-14", duration:"3", parent:"4", progress: 0.5, open: true},
			{id:11, text:"Product launch", type:gantt.config.types.project, progress: 0.6, open: true},
			{id:12, text:"Perform Initial testing", start_date:"2022-04-03", duration:"5", parent:"11", progress: 1, open: true},
			{id:13, text:"Development", type:gantt.config.types.project, start_date:"2022-04-02", duration:"7", parent:"11", progress: 0.5, open: true},
			{id:14, text:"Analysis", start_date:"2022-04-02", duration:"6", parent:"11", progress: 0.8, open: true},
			{id:15, text:"Design", type:gantt.config.types.project, start_date:"2022-04-02", duration:"5", parent:"11", progress: 0.2, open: true},
			{id:16, text:"Documentation creation", start_date:"2022-04-02", duration:"7", parent:"11", progress: 0, open: true},
			{id:17, text:"Develop System", start_date:"2022-04-03", duration:"2", parent:"13", progress: 1, open: true},
			{id:25, text:"Beta Release", start_date:"2022-04-06",type:gantt.config.types.milestone, parent:"13", progress: 0, open: true},
			{id:18, text:"Integrate System", start_date:"2022-04-08", duration:"2", parent:"13", progress: 0.8, open: true},
			{id:19, text:"Test", start_date:"2022-04-10", duration:"4", parent:"13", progress: 0.2, open: true},
			{id:20, text:"Marketing", start_date:"2022-04-10", duration:"4", parent:"13", progress: 0, open: true},
			{id:21, text:"Design database", start_date:"2022-04-03", duration:"4", parent:"15", progress: 0.5, open: true},
			{id:22, text:"Software design", start_date:"2022-04-03", duration:"4", parent:"15", progress: 0.1, open: true},
			{id:23, text:"Interface setup", start_date:"2022-04-03", duration:"5", parent:"15", progress: 0, open: true},
			{id:24, text:"Release v1.0", start_date:"2022-04-15",type:gantt.config.types.milestone, parent:"11", progress: 0, open: true}
		],
		links: [
...
.gantt_task_link.gantt_critical_link:hover .gantt_line_wrapper div {
  box-shadow: 0 2px 4px 0 rgba(255, 82, 82, 0.2);
}
...
.gantt_task_link.gantt_critical_link:hover .gantt_link_arrow_right:before {
  ...
  box-shadow: 0 2px 3px 0 rgba(255, 82, 82, 0.4), 0 1px 1px 0 rgba(255, 82, 82, 0.25);
}
.gridHoverStyle,
.gridSelection,
.timelineSelection {
...
label.gantt_resource_row
  input[type="checkbox"]:checked
  + div.gantt_resource_cell_checkbox
  .matherial_checkbox_icon {
