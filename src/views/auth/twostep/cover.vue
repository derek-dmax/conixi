                                            ...
                                            <div class="position-relative h-100 d-flex flex-column">
                                                <div class="mb-4">
                                                    <router-link to="/" class="d-block">
                                                        <img src="@/assets/images/c-logo-light.jpg" alt="" height="18">
                                                    </router-link>
                                                </div>
                                                <div class="mt-auto">
                                                    <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Didn't receive a code ? <router-link href="/auth/reset-pwd-cover" class="fw-semibold text-primary text-decoration-underline">Resend</router-link> </p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
