                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute to update links in a navigation list based on the current scroll position. Scroll the area below the navbar and watch the active class
                        ...
                        <div class="live-preview">
                            <nav id="navbar-example" class="navbar bg-light px-3">
                                <a class="navbar-brand" href="#">
                                    <img src="@/assets/images/c-logo-dark.jpg" class="card-logo card-logo-dark" alt="logo dark" height="14">
                                    <img src="@/assets/images/c-logo-light.jpg" class="card-logo card-logo-light" alt="logo light" height="14">
                                </a>
                        ...
                        <div class="d-none code-view">
                            <pre>
<code class="language-markup">&lt;nav id=&quot;navbar-example&quot; class=&quot;navbar bg-light px-3&quot;&gt;
&lt;a class=&quot;navbar-brand&quot; href=&quot;#&quot;&gt;
&lt;img src=&quot;...&quot; alt=&quot;...&quot;&gt;
&lt;/a&gt;
&lt;ul class=&quot;nav nav-pills&quot;&gt;
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-3">
                                <nav id="navbar-examplenested" class="navbar bg-light flex-column">
                                    <a class="navbar-brand mb-2" href="#">
                                        <img src="@/assets/images/c-logo-dark.jpg" class="card-logo card-logo-dark" alt="logo dark" height="15">
                                        <img src="@/assets/images/c-logo-light.jpg" class="card-logo card-logo-light" alt="logo light" height="15">
                                    </a>
